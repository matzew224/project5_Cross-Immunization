...
root_dir = '/home/vincent/sarsProject/project5_Cross-Immunization/plots/vasil_output'

# Liste der Lineages, einschließlich Wuhan-Hu-1, der keinen eigenen Ordner hat
lineages1 = ['Wuhan-Hu-1', 'JN.1', 'JN.2', 'JN.3', 'KP.3', 'XBB.1.5']
lineages2 = ['JN.1', 'JN.2', 'JN.3', 'KP.3', 'XBB.1.5']
...
def create_empty_matrix(name):
    ...
    df = pd.DataFrame('', index=lineages1, columns=lineages1)
